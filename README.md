...
- **Quest XP** — orange overlay showing estimated XP from completed quests ready to turn in
...
```
55.2%  —  125.5K / 227.3K  (101.8K remaining)  (+12.0K quests)  (+50.0K rested)  TTL: 1h 23m  T: 2h 15m
```

- **Percentage** — current level progress
- **XP values** — current / max with remaining in parentheses
- **Quests** (orange) — total XP from completed quests ready to turn in
...
- Rested XP
- Quest XP (from completed quests)
- Current level
- Time on level
- XP per hour
